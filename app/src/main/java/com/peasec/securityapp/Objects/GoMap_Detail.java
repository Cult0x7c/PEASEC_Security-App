...
public class GoMap_Detail {
    ...
    private final Activity_DetailEvent activity_detailEvent;
    ...
    public GoMap_Detail(GoogleMap googleMap, Context context){
        this.map = googleMap;
        this.context = context;
        this.activity_detailEvent = (Activity_DetailEvent) context;
    ...
    private void getDeviceLocation() {
         ...
         */
        try {
            if (this.activity_detailEvent.isLocationPermissionGranted()) {
                Task<Location> locationResult = fusedLocationProviderClient.getCurrentLocation(PRIORITY_BALANCED_POWER_ACCURACY,null);
                locationResult.addOnCompleteListener(this.activity_detailEvent, new OnCompleteListener<Location>() {
                    @Override
    ...
    public void updateLocationUI() {
        ...
        try {
            if (this.activity_detailEvent.isLocationPermissionGranted()) {
                ...
                Activity_DetailEvent activity = (Activity_DetailEvent) context;
    ...
    public void getLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this.context.getApplicationContext(),
            ...
            this.activity_detailEvent.setLocationPermissionGranted(true);
        } else {
            ActivityCompat.requestPermissions(this.activity_detailEvent,
